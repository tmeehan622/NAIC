...
class TermsViewController: UIViewController {
    ...
    func byebyeAlert(){
        ...
        let optionMenu = UIAlertController(title: "Warning", message: "Terms must be agreed to prior to using iFAR. To continue using iFAR, please tap 'Cancel' to dismiss this alert and then tap 'Agree' on the Terms and Conditions screen.", preferredStyle: .alert)
